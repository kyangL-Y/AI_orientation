...
('学习计划管理', 2000, 6, 'learningPlan', 'train/learningPlan/index', '', 1, 0, 'C', '0', '0', 'train:plans:list', 'education', 'admin', sysdate(), '学习计划管理菜单');
...
-- 3. 我的学习计划菜单（学员端）
INSERT INTO sys_menu (menu_name, parent_id, order_num, path, component, query, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, remark) VALUES
('我的学习计划', 2000, 7, 'myPlans', 'train/learningPlan/myPlans', '', 1, 0, 'C', '0', '0', 'train:plans:list', 'user', 'admin', sysdate(), '我的学习计划菜单');
